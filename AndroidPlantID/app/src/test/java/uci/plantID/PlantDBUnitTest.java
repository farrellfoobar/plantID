...
public class PlantDBUnitTest extends InstrumentationTestCase
{
    ...
    @Test
    public void canGetMatches( AssetManager assetManager) throws Exception
    {
        InputStreamReader is = new InputStreamReader( new FileInputStream(yourLoc + testingLoc) );
        plantDatabase db = new plantDatabase( assetManager );
